Feature: UMS
  ...
  Scenario Outline: Employee page
    ...
    Examples: 
      ...
      | https://129.80.90.99/#/login | umstest@ikcontech.com | Test@123 | Krunal | Shekar | IKMU012 | krunal@ikcontech.com | Information Technology | Human Resource | Ananth raj | Male |
