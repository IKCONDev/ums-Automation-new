...
public class Internalnotes_object extends Baseclass {
	...
	public void add_the_Internalnotes_page(String IN, String Rwr, String Apr) throws InterruptedException, AWTException {
		...
		List<WebElement> bg=driver.findElements(By.xpath("//span[normalize-space()='"+Rwr+"']"));
		clickmultipleweb(bg);
		//		Clickelement(Reviewerselect);
		Clickelement(Approverdrpdwn);

		List<WebElement> dg=driver.findElements(By.xpath("(//span[normalize-space()='"+Apr+"'])"));
		clickmultipleweb(dg);
	...
	public void Validate_the_Added_Internalnotes(String IN, String CB) throws InterruptedException {
		...
		validatetext(Table_data.get(2), CB);
	...
	@FindBy(xpath = "//h5[normalize-space()='Update Internal Note']")
	public WebElement Updateinternalnotes;

	@FindBy(xpath = "(//button[normalize-space()='Update'])[1]")
	public WebElement Updatebtn;

	@FindBy(xpath = "(//button[@id='closeUpdateInternalNoteModal'])[2]")
	...
	public void update_the_Internalnotes_page(String IN) throws InterruptedException {
		...
		validatetext(Updateinternalnotes, "Update Internal Note");
	...
	public void validate_the_updated_Internalnotes_page(String IN, String CB) throws InterruptedException {
		driver.navigate().refresh();
	...
	public void Delete_the_Internalnotes(String IN) throws InterruptedException {
		...
		//td[normalize-space()='']/following-sibling::td//button[@id='trashIcon']
		try {
	...
	@FindBy(xpath = "//h5[normalize-space()='Edit Columns']")
	public WebElement Editcolumntxt;
	...
	public void Editcolumn_in_Internalnotes() throws InterruptedException {
		...
		validatetext(Editcolumntxt, "Edit Columns");
