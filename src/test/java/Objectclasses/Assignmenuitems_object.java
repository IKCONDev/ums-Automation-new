...
public class Assignmenuitems_object extends Baseclass {
	...
	@FindBy(xpath = "//a[normalize-space()='Assign Menu Items & Permissions']")
...
//		String[] s={"User :","User ID :","ROLE :"};
	...
	public void add_the_Assign_MenuItems_Permisisons() throws InterruptedException {
		...
		validatetext(drop_down, "Select permissions for menu item");
...
//				for(int i=0;i<3;i++) {
//				if(driver.findElements(By.xpath("//div[@class='modal-body']//input[@type='text']")).get(i).isEnabled()) {
//					
//					if(i==0) {
