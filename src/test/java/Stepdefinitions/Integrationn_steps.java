...
public class Integrationn_steps {
	...
	@Then("Configure the webex in tool Integration page {string} {string} {string} {string} {string} {string}")
	public void Configure_the_webex_in_tool_integration_page(String WebexClientID, String WebexClientSecret, String Webextoken, String WebexExpiresin, String WebexRefreshtoken, String webexrefreshtokenexpire) throws InterruptedException {
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		IO.Configure_the_webex_in_tool_integration_page(WebexClientID,WebexClientSecret,Webextoken,WebexExpiresin,WebexRefreshtoken,webexrefreshtokenexpire);
	}
}
